...
public abstract class AsyncPeriodicWork extends PeriodicWork {
  ...
  private static final long LOG_ROTATE_SIZE = SystemProperties.getLong(AsyncPeriodicWork.class.getName() + ".logRotateSize", Long.valueOf(10485760L)).longValue();
  ...
  public final void doRun() {
    try {
      ...
      this.thread = new Thread(() -> {
            ...
            l = new LazyTaskListener(this::createListener, String.format("Started at %tc", new Object[] { new Date(startTime) }));
            try {
      ...
      LogRecord lr = new LogRecord(getErrorLoggingLevel(), "{0} thread failed with error");
      lr.setThrown(t);
