...
public abstract class TransientViewActionFactory implements ExtensionPoint {
  public abstract List<Action> createFor(View paramView);
  
  public static ExtensionList<TransientViewActionFactory> all() { return ExtensionList.lookup(TransientViewActionFactory.class); }
