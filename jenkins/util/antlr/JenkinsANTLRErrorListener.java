...
public class JenkinsANTLRErrorListener extends BaseErrorListener {
  ...
  public JenkinsANTLRErrorListener() { this.errorMessageSupplier = (() -> null); }
  
  public JenkinsANTLRErrorListener(Supplier<String> errorMessageSupplier) { this.errorMessageSupplier = errorMessageSupplier; }
  
  public void syntaxError(Recognizer<?, ?> recognizer, Object offendingSymbol, int line, int charPositionInLine, String msg, RecognitionException e) {
    String errorMessage = (String)this.errorMessageSupplier.get();
