...
public final class Symbol {
  ...
  public static String get(@NonNull SymbolRequest request) {
    ...
    String symbol = (String)((Map)SYMBOLS.computeIfAbsent(identifier, key -> new ConcurrentHashMap())).computeIfAbsent(name, key -> loadSymbol(identifier, key));
  ...
  private static String loadSymbol(String namespace, String name) {
    String markup = "<svg xmlns=\"http://www.w3.org/2000/svg\" class=\"ionicon\" height=\"48\" viewBox=\"0 0 512 512\"><title>Close</title><path fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"32\" d=\"M368 368L144 144M368 144L144 368\"/></svg>";
    ClassLoader classLoader = getClassLoader(namespace);
    if (classLoader != null)
      try {
        InputStream inputStream = classLoader.getResourceAsStream("images/symbols/" + name + ".svg");
        try {
          if (inputStream != null) {
